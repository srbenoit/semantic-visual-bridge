...
- Must include source-type tagging (D-028 — GR proposes, LLM proposes, system commits).
- Must address all six spec slots (D-027).
**Open sub-questions:**
...
**Constraints:** Must exhibit all eight spec properties (D-016). Must accommodate six slots with
distinct write permissions (D-027). Must support Data Section with typed content (D-032). Math
must be first-class (D-013).
